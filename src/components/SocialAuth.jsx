            ...
            signInWithPopup(auth, provider)
              .then(async (result) => {
                ...
                if (!userDoc.exists()) {
                  ...
                  let firstName;
                  if (
                    auth.currentUser.providerData[0].firstName != null &&
                    auth.currentUser.providerData[0].firstName != undefined
                  ) {
                  ...
                  let lastName;
                  if (
                    auth.currentUser.providerData[0].lastName != null &&
                    auth.currentUser.providerData[0].lastName != undefined
                  ) {
                  ...
                  await addDoc(userImagesRef, {
                    url: auth.currentUser.providerData[0].photoURL,
                  });
                }
