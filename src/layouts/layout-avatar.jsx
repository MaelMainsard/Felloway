    ...
    return (
        <div className='avatar'>
            <div className="w-8 rounded-full">
                {avatar ? (
                    <img src={avatar} className='object-cover rounded-full w-8 avatar' />
                ) : (
          ...
          <div className="w-14 rounded-full">
            {message_preview.is_chat ?
              message_preview.users[other_user].avatar ?
                <img src={message_preview.users[other_user].avatar} className='object-cover rounded-full w-14' /> :
              ...
              message_preview.group_img ?
                <img src={message_preview.group_img} className='object-fill rounded-full w-14' /> :
                <div className="avatar placeholder">
                <div className="bg-neutral text-neutral-content rounded-full w-14">
